...
if ( ! function_exists( 'trav_register_accommodation_post_type' ) ) {
	function trav_register_accommodation_post_type() {
		$labels = array(
			...
			'singular_name'       => _x( 'Khách sạn', 'Post Type Singular Name', 'trav' ),
			'menu_name'           => __( 'Khách sạn', 'trav' ),
			'all_items'           => __( 'Tất cả khách sạn', 'trav' ),
			'view_item'           => __( 'View Accommodation', 'trav' ),
			'add_new_item'        => __( 'Thêm mới', 'trav' ),
			'add_new'             => __( 'Thêm mới', 'trav' ),
...
if ( ! function_exists( 'trav_register_location_taxonomy' ) ) {
	function trav_register_location_taxonomy(){
		$labels = array(
				...
				'singular_name'     => _x( 'Tỉnh / Thành phố', 'taxonomy singular name', 'trav' ),
				'menu_name'         => __( 'Tỉnh / Thành phố', 'trav' ),
...
if ( ! function_exists( 'trav_register_amenity_taxonomy' ) ) {
	function trav_register_amenity_taxonomy(){
		$labels = array(
				'name'              => _x( 'Tiện ích', 'taxonomy general name', 'trav' ),
				'singular_name'     => _x( 'Tiện ích', 'taxonomy singular name', 'trav' ),
				'menu_name'         => __( 'Tiện ích', 'trav' ),
				'all_items'         => __( 'Tất cả tiện ích', 'trav' ),
				'parent_item'                => null,
				'parent_item_colon'          => null,
				'new_item_name'     => __( 'Thêm tiện ích', 'trav' ),
				'add_new_item'      => __( 'Thêm tiện ích', 'trav' ),
				'edit_item'         => __( 'Sửa tiện ích', 'trav' ),
				'update_item'       => __( 'Cập nhật tiện ích', 'trav' ),
...
if ( ! function_exists( 'trav_register_tour_post_type' ) ) {
	function trav_register_tour_post_type() {
		$labels = array(
			...
			'all_items'           => __( 'Tất cả', 'trav' ),
			'view_item'           => __( 'View Tour', 'trav' ),
			'add_new_item'        => __( 'Thêm mới Tour', 'trav' ),
			'add_new'             => __( 'Thêm mới Tour', 'trav' ),
			'edit_item'           => __( 'Chỉnh sửa', 'trav' ),
			'update_item'         => __( 'Cập nhật', 'trav' ),
			'search_items'        => __( 'Tìm kiếm', 'trav' ),
