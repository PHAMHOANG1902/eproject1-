                        ...
                        <div class="comment-header clearfix">
                            ...
                            <div class="review-score">
                                <div class="five-stars-container">
                                    <div class="five-stars" style="width: <?php echo esc_attr($review['review_rating'] / 5 * 100); ?>%;"></div>
                                </div>
...
if (!function_exists('trav_breadcrumbs')) {
    function trav_breadcrumbs()
    {
        ...
        if (is_home()) {
            ...
            if (!is_front_page()) {
                echo '<li><a href="' . esc_url(home_url()) . '" title="' . esc_attr__('Home', 'trav') . '">Home</a></li>';
            }
            ...
            if (is_search()) {
                ...
                echo esc_html__('Kết quả tìm kiếm', 'trav');
                echo "</li>";
            }
                ...
                <?php if ('' != get_the_post_thumbnail($post_id)) { ?>
                    ...
                    <div class="details">
                        <?php if ($list_style == "style1") { ?>
                            <h4 class="post-title entry-title"><a href="<?php echo esc_url(get_permalink($post_id)); ?>"><?php echo wp_kses_post(get_the_title($post_id)); ?></a></h4>
                            <div><?php echo wp_kses_post($brief); ?></div>
                            <div class="post-meta single-line-meta vcard">
                                <?php echo __('By', 'trav') ?> <span class="fn"><?php the_author_posts_link(); ?></span>
                            </div>
