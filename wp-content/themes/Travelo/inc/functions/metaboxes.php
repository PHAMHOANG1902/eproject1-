	...
	function trav_register_acc_meta_boxes() {
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				array(
					'name'  => __( 'Giá tối thiểu mỗi đêm', 'trav' ),
		...
		$meta_boxes[] = array(
			...
			'title' => __( 'Giới thiệu địa điểm', 'trav' ),
			'pages' => array( 'accommodation' ),
			'context' => 'normal',
			'priority' => 'high',
			'fields' => array(
				array(
					'name'  => __( 'Quốc gia', 'trav' ),
					'id'      => "{$prefix}country",
		...
		$meta_boxes[] = array(
			...
			'title' => __( 'Chính sách', 'trav' ),
			'pages' => array( 'accommodation' ),
			'context' => 'normal',
			'priority' => 'high',
			'fields' => array(
				array(
					'name'  => __( 'Check-in', 'trav' ),
					'id'      => "{$prefix}check_in",
					'type'  => 'text',
				),
				array(
					'name'  => __( 'Check-out', 'trav' ),
					'id'      => "{$prefix}check_out",
					'type'  => 'text',
				),
				array(
					'name'  => __( 'Chính sách đổi / Hủy / Thanh toán', 'trav' ),
			...
			/*
				...
				// ),
				array(
					'name'  => __( 'Mang thú nuôi', 'trav' ),
					'id'      => "{$prefix}pets",
					'type'  => 'textarea',
				),
				array(
					'name'  => __( 'Chấp nhận thanh toán thẻ', 'trav' ),
					'id'      => "{$prefix}cards",
					'type'  => 'textarea',
				),
				array(
		...
		$meta_boxes[] = array(
			...
			'title' => __( 'Settings', 'trav' ),
			'pages' => array( 'accommodation' ),
			'context' => 'side',
			'priority' => 'default',
			'fields' => array(
				array(
					'name' => __( 'Thêm vào khách sạn tiêu biểu', 'trav' ),
					'id'    => "{$prefix}featured",
					'desc' => __( 'Thêm vào danh sách khách sạn tiêu biểu.', 'trav' ),
					'type' => 'checkbox',
					'std' => array(),
				),
				array(
					'name' => __( 'Giảm giá', 'trav' ),
					'id' => "{$prefix}hot",
					'desc' => __( 'Thêm vào hotlist', 'trav' ),
					'type' => 'checkbox',
					'std' => array(),
				),
				array(
					'name' => __( 'Phần trăm giảm giá', 'trav' ),
	...
	function trav_register_tour_meta_boxes() {
		...
		$meta_boxes[] = array(
			...
			'fields' => array(
				...
				// ),
				array(
					'name' => __( 'Khuyến mãi', 'trav' ),
					'id' => "{$prefix}hot",
					'desc' => __( 'Khuyến mãi tour.', 'trav' ),
					'type' => 'checkbox',
					'std' => array(),
				),
				array(
					'name' => __( 'Phần trăm khuyến mãi', 'trav' ),
					'id' => "{$prefix}discount_rate",
					'desc' => __( '%', 'trav' ),
					'type' => 'number',
					'std' => 0,
