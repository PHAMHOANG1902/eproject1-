    ...
    class TravShortcodes
{
        ...
        public function shortcode_column($atts, $content = null)
    {
            ...
            foreach ($devices as $device) {
                ...
                //grid column class
                if (${$device} != '') {
                    $classes[] = 'col-' . $device . '-' . ${$device};
                }

                //grid offset class
                $device_off = $device . 'off';
                if (${$device_off} != '') {
                    $classes[] = 'col-' . $device . '-offset-' . ${$device_off};
                }
        ...
        //shortcode one_half
        public function shortcode_one_half($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
                'offset' => 0,
        ...
        //shortcode one_third
        public function shortcode_one_third($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
                'offset' => 0,
        ...
        //shortcode two_third
        public function shortcode_two_third($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
                'offset' => 0,
        ...
        public function shortcode_one_fourth($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
                'offset' => 0,
        ...
        public function shortcode_three_fourth($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
                'offset' => 0,
        ...
        public function shortcode_five_column($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
                'no_margin' => 'no',
        ...
        public function shortcode_container($atts, $content = null)
    {
         ...
         * ********************* Section Shortcode ************************
         * **************************************************************** */
        public function shortcode_section($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
            ), $atts));
         ...
         * ********************** Block Shortcode *************************
         * **************************************************************** */
        public function shortcode_block($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'type' => '',
                'class' => '',
         ...
         * **************************************************************** */
        public function shortcode_folded_corner_block($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'class' => '',
                'background' => '#fff',
        ...
        public function shortcode_toggles($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'title' => '',
         ...
         * **************** Toggle Shortcode ******************************
         * **************************************************************** */
        public function shortcode_toggle($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'title' => '',
                'collapsed' => 'yes',
        ...
        public function shortcode_blockquote($atts, $content = null)
    {
         ...
         * **************************************************************** */
        public function shortcode_social_links($atts, $content = null)
    {
        ...
        public function shortcode_dropcap($atts, $content = null)
    {
         ...
         * **************************************************************** */
        public function shortcode_checklist($atts, $content = null)
    {
        ...
        public function shortcode_testimonials($atts, $content = null)
    {
         ...
         * **************************************************************** */
        public function shortcode_testimonial($atts, $content = null)
    {
         ...
         * **************** Icon Box Shortcode ****************************
         * **************************************************************** */
        public function shortcode_icon_box($atts, $content = null)
    {
            extract(shortcode_atts(array(
                'icon' => '',
     ...
     * **************************************************************** */
    public function shortcode_parallax_block($atts, $content = null)
    {
        extract(shortcode_atts(array(
            'ratio' => '0.5',
            'bg_image' => '',
     ...
     * **************************************************************** */
    public function shortcode_border_box($atts, $content = null)
    {
        extract(shortcode_atts(array(
            'class' => '',
        ), $atts));
     ...
     * **************************************************************** */
    public function shortcode_accommodation_booking($atts, $content = null)
    {
        ob_start();
     ...
     * **************************************************************** */
    public function shortcode_accommodation_booking_confirmation($atts, $content = null)
    {
        ob_start();
     ...
     * **************************************************************** */
    public function shortcode_accommodations($atts)
    {
        extract(shortcode_atts(array(
            'title' => '',
            'type' => 'latest',
     ...
     * **************************************************************** */
    public function shortcode_similar_accommodations($atts)
    {
        extract(shortcode_atts(array(
        ...
        if (get_post_type($acc_id) != 'accommodation') {
            return false;
        }
     ...
     * **************************************************************** */
    public function shortcode_tour_booking($atts, $content = null)
    {
        ob_start();
     ...
     * **************************************************************** */
    public function shortcode_tour_booking_confirmation($atts, $content = null)
    {
        ob_start();
     ...
     * ****************** Tour List Shortcode ****************
     * **************************************************************** */
    public function shortcode_tours($atts)
    {
        extract(shortcode_atts(array(
            'title' => '',
            'type' => 'latest',
     ...
     * **************************************************************** */
    public function shortcode_latest_tours($atts)
    {
        extract(shortcode_atts(array(
            // 'title' => __( 'Similar Accommodations', 'trav' ),
            'count' => 3,
        ...
        foreach ($tours as $tour) {
            ...
            $result .= '</figure>';
            $result .= '<div class="details dd">';
            $result .= '<h5 class="title"><a href="' . esc_url(get_permalink($tour_id)) . '">' . esc_html(get_the_title($tour_id)) . '</a></h5>';
            $result .= '<label class="price-wrapper"><span class="price-per-unit">' . esc_html(trav_get_price_field($min_price)) . '</span>mỗi người</label>';
            $result .= '</div>';
            $result .= '</article>';
        }
        $result .= '</div>';
     ...
     * ************************* Blog Shortcode ***********************
     * **************************************************************** */
    public function shortcode_blog($atts, $content = null)
    {
     ...
     * *********************** Dashboard Shortcode ********************
     * **************************************************************** */
    public function shortcode_dashboard($atts, $content = null)
    {
        ob_start();
    ...
    {
        $variables = array('type' => 'gallery2', 'id' => '', 'class' => '', 'ul_class' => ''); //available type values ( gallery1|gallery2|gallery3|gallery4|carousel1|carousel2 )
        extract(shortcode_atts($variables, $atts));
     ...
     * ************************* Slide Shortcode **********************
     * **************************************************************** */
    public function shortcode_slide($atts, $content = null)
    {
     ...
     * ************************* bgslider Shortcode **********************
     * **************************************************************** */
    public function shortcode_bgslider($atts, $content = null)
    {
     ...
     * *********************** Image Box Shortcode ********************
     * **************************************************************** */
    public function shortcode_imageframe($atts, $content = null)
    {
        ...
        if ($link != "no") {
            $result .= '<a href="' . esc_url($link) . '" title="' . esc_attr($title) . '"' . $a_class . '>';
        }

        $result .= '<img src="' . esc_url($src) . '"' . $alt . $width . $height . $img_class . $animation . ' />';
        $result .= do_shortcode($content);
        if ($hover == 'opacity') {
            $result .= '<span class="opacity-wrapper"></span>';
        }
        ...
        if (!empty($label_content)) {
            $result .= '<figcaption>' . $label_content . '</figcaption>';
        }
     ...
     * **************************************************************** */
    public function shortcode_content_boxes($atts, $content = null)
    {
     ...
     * **************************************************************** */
    public function shortcode_content_box_detail($atts, $content = null)
    {
        $variables = array('class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : ' ' . $class;
     ...
     * **************************************************************** */
    public function shortcode_content_box_detail_row($atts, $content = null)
    {
        $variables = array('class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : ' ' . $class;
     ...
     * **************************************************************** */
    public function shortcode_content_box_action($atts, $content = null)
    {
        $variables = array('class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : ' ' . $class;
     ...
     * *********************** Promo Box Shortcode ********************
     * **************************************************************** */
    public function shortcode_promo_box($atts, $content = null)
    {
        ...
        if (!is_numeric($content_section_width)) {
            $content_section_width = 8;
        }

        if (!is_numeric($img_section_width)) {
            $img_section_width = 12 - $content_section_width;
        }
     ...
     * **************************************************************** */
    public function shortcode_promo_box_left($atts, $content = null)
    {
        $variables = array('class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : (' ' . $class);
     ...
     * **************************************************************** */
    public function shortcode_promo_box_right($atts, $content = null)
    {
        $variables = array('class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : (' ' . $class);
     ...
     * **************************************************************** */
    public function shortcode_search_form($atts, $content = null)
    {
        $variables = array('class' => '', 'method' => 'get', 'post_type' => 'post', 'style' => 'style1');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : (' class="' . esc_attr($class) . '"');
        $method = ($method == 'get') ? 'get' : 'post';
        $def_post_types = array('post', 'accommodation', 'tour');
...
$max_kid_age = 17;
		...
		<?php } elseif ($post_type == 'tour' && empty($content)) {?>
			<?php if ($style == 'style2'): ?>
				<div class="search-box">
					<form role="search" method="get" id="searchform" class="tour-searchform2" action="<?php echo esc_url(home_url('/')); ?>">
     ...
     * **************************************************************** */
    public function shortcode_search_form_textfield($atts, $content = null)
    {
     ...
     * **************************************************************** */
    public function shortcode_search_group($atts, $content = null)
    {
				...
				<?php if (count($enabled_features) > 1): ?>
					<ul class="search-tabs clearfix">
						<?php if (in_array('acc', $enabled_features)): ?>
							<li <?php if ($enabled_features[0] == 'acc') {
            echo 'class="active"';
        }
        ?> ><a href="#hotels-tab" data-toggle="tab"><i class="soap-icon-hotel"></i> <span><?php _e('HOTELS', 'trav')?></span></a></li>
						<?php endif;?>
						<?php if (in_array('tour', $enabled_features)): ?>
							<li <?php if ($enabled_features[0] == 'tour') {
            echo 'class="active"';
        }
        ?> ><a href="#tours-tab" data-toggle="tab"><i class="soap-icon-beach"></i> <span><?php _e('TOURS', 'trav')?></span></a></li>
						<?php endif;?>
					</ul>
        ...
        ?> ><a href="#hotels-tab" data-toggle="tab"><?php _e('HOTELS', 'trav')?></a></li>
						<?php endif;?>
						<?php if (in_array('tour', $enabled_features)): ?>
							<li <?php if ($enabled_features[0] == 'tour') {
            echo 'class="active"';
        }
        ?> ><a href="#tours-tab" data-toggle="tab"><?php _e('TOURS', 'trav')?></a></li>
						<?php endif;?>
					</ul>
				</div>
				<?php endif;?>
            ...
            ?>
					<div class="search-tab-content">
						<?php if (in_array('acc', $enabled_features)): ?>
							<?php if (count($enabled_features) > 1): ?>
								<div class="tab-pane fade<?php if ($enabled_features[0] == 'acc') {
                echo ' active in';
            }
            ?>" id="hotels-tab">
							<?php endif;?>
...
$adults = (isset($_GET['adults']) && is_numeric((int) $_GET['adults'])) ? (int) $_GET['adults'] : 1;
            ...
            ?>
						...
						<?php if (in_array('tour', $enabled_features)): ?>
							<?php if (count($enabled_features) > 1): ?>
								<div class="tab-pane fade<?php if ($enabled_features[0] == 'tour') {
                echo ' active in';
            }
            ?>" id="tours-tab">
							<?php endif;?>
...
$kids = (isset($_GET['kids']) && is_numeric((int) $_GET['kids'])) ? (int) $_GET['kids'] : 0;
            ...
            ?>
									...
									<div class="age-of-children <?php if ($kids == 0) {
                echo 'no-display';
            }
            ?>">
										<h5><?php _e('Age of Children', 'trav');?></h5>
...
$max_kid_age = 17;
     ...
     * *********************** Animation Shortcode ********************
     * **************************************************************** */
    public function shortcode_animation($atts, $content = null)
    {
        $variables = array('type' => 'fadeInUp', 'duration' => '2', 'delay' => '0', 'class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : (' ' . $class);
        $result = '';
     ...
     * **************************************************************** */
    public function shortcode_rating($atts, $content = null)
    {
     ...
     * ************************ Person Shortcode **********************
     * **************************************************************** */
    public function shortcode_person($atts, $content = null)
    {
     ...
     * ************************ Person Shortcode **********************
     * **************************************************************** */
    public function shortcode_team_member($atts, $content = null)
    {
    ...
    public function shortcode_map($atts, $content = null)
    {
        ...
        if (empty($type) || !in_array($type, $map_types)) {
            $type = 'ROADMAP';
        }
        ...
        $center_str = '';
        if (!empty($center)) {
            $center_str = 'center: [' . esc_attr($center) . '],';
        }
        ...
        if (!empty($markers)) {
            ...
            foreach ($markers as $marker) {
                ...
                if (isset($marker[1])) {
                    $marker_val_str .= ', data:"' . esc_js($marker[1]) . '"';
                }
     ...
     * **************************************************************** */
    public function shortcode_pricing_table_vc($atts, $content = null)
    {
        $variables = array('class' => '',
            'color' => 'white',
            'price' => '',
     ...
     * **************************************************************** */
    public function shortcode_pricing_table_head($atts, $content = null)
    {
        ...
        if (!empty($icon)) {
            $result .= '<i class="' . esc_attr($icon . $icon_class) . '"></i>';
        }
     ...
     * **************************************************************** */
    public function shortcode_pricing_table_content($atts, $content = null)
    {
        $variables = array('class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : (' ' . $class);
     ...
     * **************************************************************** */
    public function shortcode_pricing_table_features($atts, $content = null)
    {
        $variables = array('class' => '');
        extract(shortcode_atts($variables, $atts));
        $class = empty($class) ? '' : (' ' . $class);
     ...
     * *********************** Images Shortcode ***********************
     * **************************************************************** */
    public function shortcode_images($atts, $content = null)
    {
     ...
     * ************************ Location List *************************
     * **************************************************************** */
    public function shortcode_locations($atts, $content = null)
    {
