		...
		if ( tjq("#price-range").length ) {
			...
			tjq("#price-range").slider({
				...
				slide: function(event, ui) {
					...
					// min price text
					tjq(".min-price-label").text(formatNumber(ui.values[ 0 ] , ',' , '.') + ' ' + def_currency);
					...
					tjq(".max-price-label").text(formatNumber(max_price,',','.') + ' ' + def_currency);
				},
			...
			tjq(".min-price-label").text(tjq("#price-range").slider("values", 0) + ' ' + def_currency);
			if (tjq("#price-range").slider("values", 1) == price_slide_max_val) {
				tjq(".max-price-label").text(formatNumber(price_slide_last_val,',','.') + ' ' + def_currency   + "+");
			} else {
				tjq(".max-price-label").text( formatNumber(tjq("#price-range").slider("values", 1) , ',', '.') + ' ' + def_currency);
			}
		}
