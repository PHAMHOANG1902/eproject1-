...
if (have_posts()) {
    ...
    $active_class = ' class="active"';
        ...
        ?>
            ...
            $active_class = ''; ?>" id="travel-guide-info">
            ...
            ?>
										<div class="tab-pane fade<?php echo esc_attr($active_class);
            $active_class = ''; ?>" id="travel-guide-sports">
            ...
            ?>
										<div class="tab-pane fade<?php echo esc_attr($active_class);
            $active_class = ''; ?>" id="travel-guide-culture-history">
            ...
            ?>
										<div class="tab-pane fade<?php echo esc_attr($active_class);
            $active_class = ''; ?>" id="travel-guide-nightlife">
											<?php echo balanceTags(do_shortcode($nightlife)); ?>
										</div>
									<?php }?>
									<?php if (!empty($acc_list)) {
            ?>
										<div class="tab-pane gray-bg fade<?php echo esc_attr($active_class);
            $active_class = ''; ?>" id="travel-guide-hotels">
    ...
    if ($current_view == 'block') {
        ...
        ?>
									<div class="tab-pane gray-bg fade<?php echo esc_attr($active_class);
        $active_class = ''; ?>" id="travel-guide-tours">
										<div class="sort-by-section clearfix box">
											<h4 class="sort-by-title block-sm"><?php _e('Sort results by:', 'trav');?></h4>
											<ul class="sort-bar clearfix block-sm">
												<?php
