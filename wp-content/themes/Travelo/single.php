						...
						<div class="post" id="post-<?php echo esc_attr( $post_id ); ?>">
							...
							<div class="details<?php echo ( empty( $isv_setting ) || ( $isv_setting == 'no' ) )?' without-featured-item':''; ?>">
								...
								<div class="post-content entry-content">
									<?php the_content();?>
									<div class="fb-like" data-href="<?php get_permalink(); ?>"  data-action="like" data-show-faces="false" data-share="true"></div><div data-width="100%" class="fb-comments" data-href="<?php get_permalink(); ?>" data-numposts="15"></div>
