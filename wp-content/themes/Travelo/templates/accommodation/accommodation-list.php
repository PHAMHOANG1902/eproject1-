   ...
   // $acc_id = $acc->ID;
    ...
    if ( $current_view == 'block' ) { ?>
        ...
        <article class="box">
            ...
            <div class="details">
                ...
                <label class="price-wrapper"><span class="price-per-unit"><?php echo esc_html( trav_get_price_field( $avg_price ) ); ?></span><?php _e( 'mỗi đêm', 'trav' ) ?></label>
            </div>
        </article>
    ...
    <?php } elseif ( $current_view == 'grid' ) { ?>
        ...
        <article class="box">
            ...
            <div class="details">
                <span class="price">
                    <small><?php _e( 'mỗi đêm', 'trav' ) ?></small><?php echo esc_html( trav_get_price_field( $avg_price ) ); ?>
                </span>
                <h4 class="box-title"><a href="<?php echo esc_url( $url ); ?>"><?php echo esc_html( get_the_title( $acc_id ) );?></a><?php echo trav_acc_get_star_rating( $acc_id ); ?><small><?php echo esc_html( trav_acc_get_city( $acc_id ) . ' ' . trav_acc_get_country( $acc_id ) ); ?></small></h4>
                <div class="feedback">
